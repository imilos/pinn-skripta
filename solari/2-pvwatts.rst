...
Као што је већ речено у претходном одељку :ref:`solari_uvod`, за моделовање ФПНМ методом користићемо једноставан *PVWAtts* модел :cite:t:`dobos2014pvwatts`. Вертикала модела састоји се из три корака:
