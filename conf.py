...
project = 'Неуронске мреже подржане физичким законима - Практикум'
...
''',
    ...
    'maketitle': r'''
     \newcommand\sphinxbackoftitlepage{
        ...
        \textbf{Неуронске мреже подржане физичким законима} \\
        \textbf{Практикум}
...
latex_documents = [(master_doc, 'pinn-skripta.tex', 'Неуронске мреже подржане физичким законима - Практикум', 'Милош Ивановић', 'manual', True)]

# -- Options for manual page output ------------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, 'PINN', 'Неуронске мреже подржане физичким законима - Практикум', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'PINN', 'Неуронске мреже подржане физичким законима - Практикум', author,
