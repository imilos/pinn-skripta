...
Решење наше логистичке једначине је добро позната сигмоидна функција приказана на :numref:`sigmoid`.
...
Ваља напоменути да примери нису сортирани по тежини, већ искључиво по феноменологији која се моделује. Ако ипак треба да препоручимо читаоцу одакле да крене са практичним радом, рецимо да :ref:`oscilacije` и :ref:`stap` представљају добру основу.
