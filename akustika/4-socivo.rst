...
Квалитативно гледано, ФЗНМ решење има исте карактеристике као МКЕ решење. Међутим, око сочива и прима границама :math:`\Gamma_2` очигледан је пад квалитета решења. Узрок можемо тражити на неколико места:

- Прво, код МКЕ је извор на линији сочива :math:`\Gamma_1` могуће прецизније специфицирати по самој линији, а не у тачкама као код ФЗНМ. 
